...
export function initContract(a, s, r, seq, abi, payload, showRes) {
...
export function invokeContract(a, s, r, seq, abi, d, func, showRes) {
...
export async function safeInvokeContract(a, s, r, seqObj, abi, d, func, showRes) {
